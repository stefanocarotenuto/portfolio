(function () {
  ...
  const EN = {
    ...
    'link-email':     'Email',
    'privacy':        'This site uses no cookies and collects no personal data. It loads Supria Sans via Adobe Fonts (<a href="https://www.adobe.com/privacy/policies/adobe-fonts.html" target="_blank" rel="noopener noreferrer">Adobe privacy policy<span class="vh"> (opens in new tab)</span></a>).',
  };
