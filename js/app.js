(function () {
  ...
  const EN = {
    ...
    'link-email':     'Email',
    'privacy':        'This site uses no cookies and collects no personal data. It loads Adobe Caslon Pro via Adobe Fonts (<a href="https://www.adobe.com/privacy/policy.html" target="_blank" rel="noopener noreferrer">Adobe privacy policy<span class="visually-hidden"> (opens in new tab)</span></a>).',
  };
